...
export default function Navbar() {
  ...
  // Backdrop blur when user scrolls down
  useEffect(() => {
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-4 flex items-center justify-between">
        ...
        >
          ...
          <span className="hidden sm:block text-slate-500 text-sm font-light">
            / portfolio
          </span>
        </motion.button>
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden w-9 h-9 flex items-center justify-center rounded-xl glass text-slate-400 hover:text-white transition-colors"
